"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9978:function(e,t,r){r.d(t,{JU:function(){return doc},QT:function(){return getDoc},ad:function(){return getFirestore}});var n,i,s=r(3991),o=r(5538),a=r(6914),l=r(8745),u=r(613);r(2601);let c="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let S="WebChannelConnection";let __PRIVATE_WebChannelConnection=class __PRIVATE_WebChannelConnection extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.fo=t+"://"+e.host,this.po=`projects/${r}/databases/${n}`,this.yo="(default)"===this.databaseId.database?`project_id=${r}`:`project_id=${r}&database_id=${n}`}get wo(){return!1}So(e,t,r,n,i){let s=__PRIVATE_generateUniqueDebugId(),o=this.bo(e,t);__PRIVATE_logDebug("RestConnection",`Sending RPC '${e}' ${s}:`,o,r);let a={"google-cloud-resource-prefix":this.po,"x-goog-request-params":this.yo};return this.Do(a,n,i),this.Co(e,o,a,r).then(t=>(__PRIVATE_logDebug("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw __PRIVATE_logWarn("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",o,"request:",r),t})}vo(e,t,r,n,i,s){return this.So(e,t,r,n,i)}Do(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+h}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}bo(e,t){let r=v[e];return`${this.fo}/v1/${t}:${r}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Co(e,t,r,n){let i=__PRIVATE_generateUniqueDebugId();return new Promise((s,o)=>{let a=new u.JJ;a.setWithCredentials(!0),a.listenOnce(u.tw.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case u.jK.NO_ERROR:let t=a.getResponseJson();__PRIVATE_logDebug(S,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case u.jK.TIMEOUT:__PRIVATE_logDebug(S,`RPC '${e}' ${i} timed out`),o(new FirestoreError(d.DEADLINE_EXCEEDED,"Request time out"));break;case u.jK.HTTP_ERROR:let r=a.getStatus();if(__PRIVATE_logDebug(S,`RPC '${e}' ${i} failed with status:`,r,"response text:",a.getResponseText()),r>0){let e=a.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(d).indexOf(t)>=0?t:d.UNKNOWN}(t.status);o(new FirestoreError(e,t.message))}else o(new FirestoreError(d.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new FirestoreError(d.UNAVAILABLE,"Connection failed."));break;default:fail()}}finally{__PRIVATE_logDebug(S,`RPC '${e}' ${i} completed.`)}});let l=JSON.stringify(n);__PRIVATE_logDebug(S,`RPC '${e}' ${i} sending request:`,n),a.send(t,"POST",l,r,15)})}Fo(e,t,r){let i=__PRIVATE_generateUniqueDebugId(),s=[this.fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=(0,u.UE)(),a=(0,u.FJ)(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;void 0!==c&&(l.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Do(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;let h=s.join("");__PRIVATE_logDebug(S,`Creating RPC '${e}' stream ${i}: ${h}`,l);let _=o.createWebChannel(h,l),m=!1,f=!1,g=new __PRIVATE_StreamBridge({lo:t=>{f?__PRIVATE_logDebug(S,`Not sending because RPC '${e}' stream ${i} is closed:`,t):(m||(__PRIVATE_logDebug(S,`Opening RPC '${e}' stream ${i} transport.`),_.open(),m=!0),__PRIVATE_logDebug(S,`RPC '${e}' stream ${i} sending:`,t),_.send(t))},ho:()=>_.close()}),__PRIVATE_unguardedEventListen=(e,t,r)=>{e.listen(t,e=>{try{r(e)}catch(e){setTimeout(()=>{throw e},0)}})};return __PRIVATE_unguardedEventListen(_,u.ii.EventType.OPEN,()=>{f||__PRIVATE_logDebug(S,`RPC '${e}' stream ${i} transport opened.`)}),__PRIVATE_unguardedEventListen(_,u.ii.EventType.CLOSE,()=>{f||(f=!0,__PRIVATE_logDebug(S,`RPC '${e}' stream ${i} transport closed`),g.Vo())}),__PRIVATE_unguardedEventListen(_,u.ii.EventType.ERROR,t=>{f||(f=!0,__PRIVATE_logWarn(S,`RPC '${e}' stream ${i} transport errored:`,t),g.Vo(new FirestoreError(d.UNAVAILABLE,"The operation could not be completed")))}),__PRIVATE_unguardedEventListen(_,u.ii.EventType.MESSAGE,t=>{var r;if(!f){let s=t.data[0];s||fail();let o=s.error||(null===(r=s[0])||void 0===r?void 0:r.error);if(o){__PRIVATE_logDebug(S,`RPC '${e}' stream ${i} received error:`,o);let t=o.status,r=function(e){let t=n[e];if(void 0!==t)return __PRIVATE_mapCodeFromRpcCode(t)}(t),s=o.message;void 0===r&&(r=d.INTERNAL,s="Unknown error status: "+t+" with message "+o.message),f=!0,g.Vo(new FirestoreError(r,s)),_.close()}else __PRIVATE_logDebug(S,`RPC '${e}' stream ${i} received:`,s),g.mo(s)}}),__PRIVATE_unguardedEventListen(a,u.ju.STAT_EVENT,t=>{t.stat===u.kN.PROXY?__PRIVATE_logDebug(S,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===u.kN.NOPROXY&&__PRIVATE_logDebug(S,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{g.Ro()},0),g}};function getDocument(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
