	...
	return (
		<div className='flex flex-col flex-grow items-center text-lg text-gray-800 py-2 px-4 overflow-y-scroll'>
			...
			<div className='flex flex-col py-5 w-full max-w-5xl'>
				...
				<div className='text-xl font-medium text-gray-800'>• How are ties for placement resolved?</div>
				<div className='pl-4 pb-4'>Ties for top placements will be resolved using the time of answer submission.</div>
				<div className='text-xl font-medium text-gray-800'>• The light theme is torturing my eyes, how do I enable dark mode?</div>
				<div className='pl-4 pb-4'>You can use the Dark Reader extension on the website, it is decently supported.</div>
